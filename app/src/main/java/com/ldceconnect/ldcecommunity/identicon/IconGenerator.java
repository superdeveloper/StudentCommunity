...
import com.ldceconnect.ldcecommunity.customlayouts.RotationLayout;
import com.ldceconnect.ldcecommunity.customlayouts.BubbleDrawable;
...
public class IconGenerator {
     ...
     */
    public IconGenerator(Context context,Bitmap bitmap) {
        mContext = context;
        //mBackground = new BitmapDrawable(bitmap);//new BubbleDrawable(mContext.getResources());
