package com.ldceconnect.ldcecommunity.customlayouts;
...
import com.ldceconnect.ldcecommunity.BuildConfig;

import static com.ldceconnect.ldcecommunity.customlayouts.SlidingDrawerUtils.getLocationInXAxis;
import static com.ldceconnect.ldcecommunity.customlayouts.SlidingDrawerUtils.getLocationInYAxis;
import static com.ldceconnect.ldcecommunity.customlayouts.SlidingDrawerUtils.getRawDisplayHeight;
import static com.ldceconnect.ldcecommunity.customlayouts.SlidingDrawerUtils.getRawDisplayWidth;
import static com.ldceconnect.ldcecommunity.customlayouts.SlidingDrawerUtils.isClicked;
...
public class SlidingDrawer extends FrameLayout {
    ...
    public SlidingDrawer(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                com.ldceconnect.ldcecommunity.R.styleable.SlidingLayer, 0, 0);

        try {
            mStickTo = a.getInteger(com.ldceconnect.ldcecommunity.R.styleable.SlidingLayer_stickTo, STICK_TO_BOTTOM);
            mOffsetDistance = a.getDimensionPixelSize(com.ldceconnect.ldcecommunity.R.styleable.SlidingLayer_offsetDistance,
